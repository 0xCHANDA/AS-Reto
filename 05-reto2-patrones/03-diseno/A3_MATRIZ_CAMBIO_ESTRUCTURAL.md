...
Esta matriz conserva el alcance de la Actividad 3. Facade fue descartado en A2; SC-3 se seleccionó e implementó posteriormente en `04-src/active/` y no se incorpora de forma retrospectiva a este artefacto histórico.
