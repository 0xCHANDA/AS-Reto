...
| R-03 | La venta debe conservar la relación entre el inventario y el producto. | 1 | 2 | 2 | Usar `vender<T>(IInventario<T>, T, uint)`, que liga ambos tipos en compilación. | La firma genérica impide pasar un producto incompatible. |
